...
# Logistic time-weighting parameters for:
...
def f_weight(t):
    """Logistic delay weight. t is months from publication to retraction."""
...
#print("time weighting: f(0)=0, f(12)=0.5, f(24)=2, f(infinity)=4")
